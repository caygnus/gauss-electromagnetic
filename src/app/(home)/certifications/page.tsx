...
export const metadata: Metadata = genMetadata({
    ...
    description:
        "Our commitment to quality is validated by international certifications including ISO 9001:2015, CE Marking, and BIS Certification. Recognized achievements include 5000+ successful installations worldwide and zero defect manufacturing track record.",
...
const CertificationsPage = () => {
    const breadcrumbSchema = generateBreadcrumbSchema([
        ...
        { name: "Certifications", url: ROUTES.CERTIFICATIONS },
    ])
                    ...
                    <section className="py-16 bg-primary">
                        <div className="container-industrial text-center text-background">
                            ...
                            <p className="text-background/70 max-w-2xl mx-auto">
                                Our commitment to quality is validated by
                                international certifications and recognized
                                achievements.
                            </p>
                        </div>
                    </section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-steel leading-relaxed mb-6">
                                            ...
                                            quality management. Every product we
                                            manufacture undergoes rigorous
