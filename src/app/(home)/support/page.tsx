    ...
    <section className="py-16 bg-primary">
     <div className="container-industrial text-center text-background">
      ...
      <p className="text-background/70 max-w-2xl mx-auto">
       Access technical documentation, support resources, and training materials
       for our electrical products.
      </p>
     </div>
    </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
       ...
       <div className="p-6 border border-border rounded hover:border-secondary transition-colors">
        ...
        <p className="text-sm text-steel mb-4">
         Product datasheets, installation manuals, and technical specifications.
        </p>
       ...
       <div className="p-6 border border-border rounded hover:border-secondary transition-colors">
        ...
        <p className="text-sm text-steel mb-4">
         Get expert assistance from our technical team for your application
         needs.
        </p>
        <Button variant="outline" size="sm" asChild>
       ...
       <div className="p-6 border border-border rounded hover:border-secondary transition-colors">
        ...
        <h3 className="text-lg font-semibold text-primary mb-2">Training</h3>
        <p className="text-sm text-steel mb-4">
         Training programs and educational resources for installation and
         maintenance.
        </p>
        <Button variant="outline" size="sm" asChild>
         <Link href={ROUTES.CONTACT}>Request Training</Link>
        </Button>
       </div>
       ...
       <div className="p-6 border border-border rounded hover:border-secondary transition-colors">
        ...
        <h3 className="text-lg font-semibold text-primary mb-2">Downloads</h3>
        <p className="text-sm text-steel mb-4">
         Download CAD files, technical drawings, and product documentation
         packages.
        </p>
        <Button variant="outline" size="sm" asChild>
