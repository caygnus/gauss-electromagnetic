...
export const metadata: Metadata = genMetadata({
    ...
    description:
        "Access technical documentation, support resources, training materials, and downloads for our electrical products. Get expert assistance from our technical team for installation, maintenance, and application needs.",
    path: ROUTES.SUPPORT,
    keywords: [
        "technical support",
...
export const sitemapConfig = lowPrioritySitemapConfig("monthly")

const SupportPage = () => {
    const breadcrumbSchema = generateBreadcrumbSchema([
        { name: "Home", url: ROUTES.HOME },
        { name: "Support & Resources", url: ROUTES.SUPPORT },
    ])
                    ...
                    <section className="py-16 bg-primary">
                        <div className="container-industrial text-center text-background">
                            ...
                            <p className="text-background/70 max-w-2xl mx-auto">
                                Access technical documentation, support
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div className="p-6 border border-border rounded hover:border-secondary transition-colors">
                                    ...
                                    <p className="text-sm text-steel mb-4">
                                        Product datasheets, installation
                                ...
                                <div className="p-6 border border-border rounded hover:border-secondary transition-colors">
                                    ...
                                    <p className="text-sm text-steel mb-4">
                                        Download CAD files, technical drawings,
                                        and product documentation packages.
                                    </p>
                                    <Button variant="outline" size="sm" asChild>
                                        <Link href={ROUTES.PRODUCTS}>
                                            Browse Products
