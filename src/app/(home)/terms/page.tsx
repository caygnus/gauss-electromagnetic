...
export const metadata = {
    title: "Terms of Service | Gauss Electromagnetics",
    description:
        "Terms of service and usage conditions for Gauss Electromagnetics website and services.",
}
                            ...
                            <div className="space-y-6 text-steel">
                                ...
                                <div>
                                    ...
                                    <p>
                                        ...
                                        our website for personal, non-commercial
                                        transitory viewing only. This is the
                                        grant of a license, not a transfer of
                                        title.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p>
                                        ...
                                        hereby disclaim and negate all other
                                ...
                                <div>
                                    ...
                                    <p>
                                        In no event shall Gauss Electromagnetics
                                        or its suppliers be liable for any
                                        damages (including, without limitation,
                                        damages for loss of data or profit, or
                                        due to business interruption) arising
                                ...
                                <div>
                                    ...
                                    <p>
                                        We may revise these terms of service at
                                        any time without notice. By using this
                                        website you are agreeing to be bound by
