                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-steel leading-relaxed">
                            <p>
                                GAUSS TECH reactors are engineered to deliver
                                superior performance in power systems, ensuring
                                optimal voltage regulation, harmonic mitigation,
                                and enhanced grid stability. Our reactors are
                                designed with precision to meet the demanding
                                requirements of modern industrial applications.
                            </p>
                            <p>
                                Built with high-grade materials and advanced
                                manufacturing processes, our reactor solutions
                                provide reliable operation under the most
                                challenging conditions. From power factor
                                correction to current limiting, our
                                comprehensive range addresses every power
                                quality challenge.
                            </p>
                        </div>
                    </div>
