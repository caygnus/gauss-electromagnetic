  ...
  <section id="overview" className="section-padding bg-background">
   <div className="container-industrial">
    ...
    <p className="text-steel text-center max-w-3xl mx-auto mb-12">
     The CygnusPro X500 represents a breakthrough in industrial circuit
     protection technology. Designed for mission-critical applications in
     manufacturing, energy, and infrastructure sectors, it combines advanced
     safety features with intelligent monitoring capabilities.
    </p>
