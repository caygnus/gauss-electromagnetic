    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
     ...
     <div>
      <p className="text-steel leading-relaxed">
       Gauss Electromagnetics is a Nashik-based manufacturer of quality
       electrical products like APFC panels, transformers, VFD chokes, and
       harmonic filter reactors. With over 25 years of experience, we use
       premium materials, modern manufacturing, and strict testing to ensure
       every product is reliable and long-lasting. We focus on understanding
       customer needs and provide honest service, fair pricing, and on-time
       delivery – becoming a trusted partner for all power-solution
       requirements.
      </p>
     </div>
    </div>
