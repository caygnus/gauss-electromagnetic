   ...
   <div className="grid grid-cols-1 md:grid-cols-3">
    ...
    <div className="relative aspect-square md:aspect-auto md:row-span-1">
     ...
     <div className="absolute inset-0 p-8 flex flex-col justify-end">
      ...
      <p className="text-background text-sm leading-relaxed">
       To be the most trusted name in India's electrical-power equipment
       industry delivering reliable, efficient and world-class solutions that
    ...
    <div className="relative aspect-square">
     ...
     <div className="absolute inset-0 flex items-center justify-center">
      <span className="text-background text-2xl font-bold">Mission</span>
     </div>
    </div>
    ...
    <div className="relative aspect-square">
     ...
     <div className="absolute inset-0 flex items-center justify-center">
      <span className="text-charcoal text-2xl font-bold">Values</span>
     </div>
    </div>
   </div>
  </section>
