    ...
    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-4xl mx-auto">
     ...
     <div>
      <blockquote className="text-lg md:text-xl text-charcoal leading-relaxed mb-4 italic">
       "At Gauss Electromagnetics, our goal has always been simple – engineer
       products that industries can trust for decades. Reliability is not just
       our promise, it's our culture."
      </blockquote>
      <div>
       <p className="font-semibold text-primary">Gauri Nambiar, Director</p>
       <p className="text-sm text-steel">Gauss Electromagnetics</p>
      </div>
     </div>
    </div>
   </div>
